...
//       deleteSkill(id).then(() => loadSkills());
//     }
//   };
...
//         <div>
//           <h1 style={{ fontSize: '28px', fontWeight: '600' }}>Skills</h1>
//           <p style={{ color: '#6b7280' }}>Manage all skills and their categories</p>
//         </div>
//         <button
...
//             <Search size={16} style={{ position: 'absolute', top: '10px', left: '10px', color: '#9ca3af' }} />
//             <input
...
//             <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: '14px', color: '#6b7280' }}>Name</th>
//             <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: '14px', color: '#6b7280' }}>Description</th>
//             <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: '14px', color: '#6b7280' }}>Category</th>
//             <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: '14px', color: '#6b7280' }}>Actions</th>
//           </tr>
//         </thead>

//         <tbody>
//           {filteredSkills.map(skill => (
//             <tr key={skill.id} style={{ borderTop: '1px solid #e5e7eb' }}>
